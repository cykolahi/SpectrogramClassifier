...
try:
    ...
    df = pd.read_csv('lightning_logs/version_197/metrics.csv')
    ...
    # Save the plot
    plt.savefig('SpectrogramClassifier/loss_plots/training_plot197_CNN_attention.png')
    print("Plot saved as training_plot197_CNN_attention.png")
    plt.show()
